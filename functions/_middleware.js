...
const brandData = {
  ...
  'ge': {
    ...
    about: 'GE Appliances has powered American kitchens since 1892, now headquartered in Louisville under Haier ownership. Westchester County homes feature GE\'s trusted reliability from basic models to sophisticated Profile and Cafe collections.',
  ...
  'frigidaire': {
    ...
    about: 'Frigidaire pioneered household refrigeration in 1916 and remains an Electrolux brand delivering value and reliability. Westchester County homeowners appreciate Frigidaire\'s practical innovation across all appliance categories.',
  ...
  'dacor': {
    ...
    about: 'Los Angeles-born Dacor has brought California innovation to luxury kitchens since 1965. Now a Samsung subsidiary, Dacor\'s Modernist collection features groundbreaking technology in Westchester County\'s architectural showcase homes.',
